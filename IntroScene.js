class IntroScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.hachiBack = this.add.sprite(500, 350, 'hachiwareBack', 'HachiwareBack.png').setScale(0.2);
        this.hachiFront = this.add.sprite(500, 350, 'hachiwareFront', 'HachiwareFront.png').setScale(0.2);
